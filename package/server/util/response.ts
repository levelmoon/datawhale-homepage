...
const sendResponse = (res: Response, httpCode: number, data: any, message: string, statusCode: STATUS_CODE) => {
  return res.status(httpCode).json({ status: statusCode, data, message })
}

export const sendSuccessResponse = (res: Response, data: any, message?: string, statusCode?: STATUS_CODE) => {
